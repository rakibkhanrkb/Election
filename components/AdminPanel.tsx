...
const AdminPanel: React.FC<Props> = ({ seats, onBack }) => {
  const handlePrint = (seat: Seat) => {
    ...
    const totalVotes = candidateTotals.reduce((s, c) => s + c.votes, 0);
        ...
        <body>
          ...
          <table>
            ...
            <tbody>
              ...
              `).join('')}
              <tr class="total-row">
                <td colspan="2">মোট সংগৃহীত ভোট</td>
          ...
          <table>
            ...
            <tbody>
              ${seat.centers.filter(c => c.isReported).map(center => {
                const centerTotal = Object.values(center.votes).reduce((a, b) => a + b, 0);
                return `
                  <tr>
          ...
          <div class="footer">
            <p>রিপোর্ট জেনারেট করেছেন: অ্যাডমিন প্যানেল (rakib)</p>
          </div>
      ...
      <div className="flex items-center justify-between bg-white p-6 rounded-2xl shadow-sm border">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 font-medium">সকল আসনের বিস্তারিত রিপোর্ট এবং প্রিন্ট ম্যানেজমেন্ট</p>
          </div>
        </div>
      </div>
              ...
              <div className="p-6 flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <div className="flex items-center space-x-3">
                  <button 
                    ...
                    className="flex items-center space-x-2 px-6 py-3 bg-blue-600 text-white font-bold rounded-xl hover:bg-blue-700 shadow-lg shadow-blue-100 transition-all text-sm"
                  >
